...
export const websiteTemplates: WebsiteTemplate[] = [
  {
    id: 'personal-blog',
    name: 'Personal Blog',
    description: 'Clean, readable layout for personal stories',
    icon: '📝',
    settings: {
      siteTheme: 'light',
      postsLayout: 'list',
  ...
  },
  {
    ...
    description: 'Grid layout showcasing visual content',
    icon: '📷',
    settings: {
      siteTheme: 'dark',
      postsLayout: 'masonry',
  ...
  },
  {
    id: 'tech-magazine',
    name: 'Tech Magazine',
    description: 'Modern grid for tech news and articles',
    icon: '💻',
    settings: {
      siteTheme: 'midnight',
      postsLayout: 'grid',
  ...
  },
  {
    id: 'crypto-trader',
    name: 'Crypto Trader',
    description: 'Data-rich layout for financial content',
    icon: '📊',
    settings: {
      siteTheme: 'ocean',
      postsLayout: 'list',
  ...
  },
  {
    id: 'travel-journal',
    name: 'Travel Journal',
    description: 'Vibrant layout for travel stories',
    icon: '✈️',
    settings: {
      siteTheme: 'sunset',
      postsLayout: 'masonry',
  ...
  },
  {
    id: 'gaming-hub',
    name: 'Gaming Hub',
    description: 'Dynamic layout for gaming content',
    icon: '🎮',
    settings: {
      siteTheme: 'midnight',
      postsLayout: 'grid',
  ...
  },
  {
    id: 'eco-lifestyle',
    name: 'Eco Lifestyle',
    description: 'Fresh, natural aesthetic for lifestyle content',
    icon: '🌿',
    settings: {
      siteTheme: 'green',
      postsLayout: 'grid',
  ...
  },
  {
    ...
    description: 'Elegant layout for fashion and beauty',
    icon: '👗',
    settings: {
      siteTheme: 'pink',
      postsLayout: 'masonry',
  ...
  },
  {
    id: 'coffee-shop',
    name: 'Coffee Shop',
    description: 'Warm, cozy aesthetic for food and cafe blogs',
    icon: '☕',
    settings: {
      siteTheme: 'coffee',
      postsLayout: 'list',
